...
class LocalUserRemoteUserWardenTest extends AbstractWardenTest {
  // -------------------------------------------- INSERT
  ...
  TestWaterLineDataStruct snapshotWlStruct = TestWaterLineDataStruct(
      ...
      water_error: WaterError.NONE,
      tsSpace: snapshotTrStruct.tsSpace);
  // -------------------------------------------- DELETE
